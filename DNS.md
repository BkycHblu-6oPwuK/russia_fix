...
Этот DNS помогает заходить на заблокированные сайты и сервисы, связанные с AI, без использования VPN, а также обеспечивает более быструю и стабильную работу за счет проксирования DNS-запросов через DoH/DoT.
...
- Upstream (в рабочем стабильном варианте):
	...
	([Cloudflare DoH](https://info.dns.malw.link/))
	Благодаря upstream DNS будет рабоать не только в браузере
